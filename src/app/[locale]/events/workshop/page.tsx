        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Browse events categorized as workshops. You can explore sessions, hands-on classes, and more.
            </p>
          </div>
          
          <EventListing showFilters={true} performanceType="Workshop" disablePagination={true} limit={48} />
        </div>
      </div>
