  ...
  const getAvailabilityBadge = (quantity: number) => {
    return (
      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
        ...
        {quantity > 0 ? 'Available' : 'Out of Stock'} ({quantity})
      </span>
    );
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage all equipment and rental items</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search equipment by name, description, or provider..."
            value={searchTerm}
